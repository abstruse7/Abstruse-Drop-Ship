...
function RegisterForm() {
  ...
  const defaultRole = searchParams.get("role") === "distributor" ? "DISTRIBUTOR" : "BUYER";
  ...
  async function handleSubmit(e) {
    ...
    if (form.role === "DISTRIBUTOR" && !form.companyName) {
      setError("Company name is required for distributor accounts");
      return;
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                type="button"
                onClick={() => updateForm("role", "DISTRIBUTOR")}
                className={`py-2.5 rounded-lg border text-sm font-medium transition ${
